...
const tempNow = computed(() => {
   return props.now.main.temp.toFixed(0);
})
        ...
        <div class="w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">
            <div class="flex justify-between">
                <div class="flex flex-col">
                    <span class="text-6xl font-bold">{{ tempNow }}°C</span>
            ...
            <div class="flex justify-between mt-12">
                <div class="flex flex-col items-center">
                    ...
                    <svg class="h-10 w-10 fill-current text-gray-400 mt-3" xmlns="http://www.w3.org/2000/svg"
